...
public class SushiBar {
	...
	public static class Customer extends TemplateThread{
		...
		public void execute() throws InterruptedException {
			...
			// Zgolemuvanje na brojot na luge vo barot i proverka dali ima moznost za sozdavanje grupa
			synchronized (lock) {
				numOfPeopleOnTable++;
			...
			// Zaminuvanje na posetitelto od barot i proverka dali e posleden clen na grupata.
