package mk.finki.os.project.ThePartyRoomProblem;

import mk.finki.os.project.AbstractState;
import mk.finki.os.project.BoundCounterWithRaceConditionCheck;
import mk.finki.os.project.PointsException;
import mk.finki.os.project.Switcher;
...
public class PartyState extends AbstractState {
	...
	public void studentEnter() {
		...
		log(deanPresent.assertEquals(0, 5, "Ne moze da vleze student, dekanot e vnatre"), null );
	...
	/**
	 * Dekanot smee da vleze samo ako nema studenti vo sobata ili ima poveke od 50
	 */
	public void deanEnter() {
		
		//novo assert funkcija koja proveruva dali brojot e pogolem od argumentot ili pak ednakov na 0
		log(studentsAtParty.assertLargerOrZero(50, 10, "Dekanot nema pravo da vleze"), null);
	...
	public void deanLeave() {
		log(studentsAtParty.assertEquals(0, 5, "Ne smee da izleze dekanot ako ima ushte studenti"), "dean leave");
		log(deanPresent.decrementWithMin(false),null);
	}
	
	/**
	 * Dekanot moze da ja rasipe zabavata ako ima poveke od 50 studenti vo sobata
	 */
	public void breakUpParty() {
		log(studentsAtParty.assertNotEquals(0, 5, "Dekanot rastura zabava bez nieden prisuten student"), "break up party");
	...
	{
		log(studentsAtParty.assertEquals(0, 5, "Dekanot prebaruva, a ima ushte studenti"), "conduct search");
	}
