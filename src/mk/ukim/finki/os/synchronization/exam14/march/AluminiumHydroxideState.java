...
import mk.ukim.finki.os.synchronization.exam14.march.AluminiumHydroxide.Hydrogen;
import mk.ukim.finki.os.synchronization.exam14.march.AluminiumHydroxide.Oxygen;
...
public class AluminiumHydroxideState extends AbstractState {
	...
	private static final String MAXIMUM_3_HYDROGEN = "Maximum 3 Hydrogen atoms for bonding are allowed.";
	...
	public AluminiumHydroxideState() {
		...
		Al = new BoundCounterWithRaceConditionCheck(0, 3,
	...
	public void bondOH() {
		...
		if (getThread() instanceof Oxygen) {
			...
			log(H.incrementWithMax(false), "Hydrogen for OH group");
		}
	}
	...
	public void bondAlOH3() {
		...
		if (getThread() instanceof Oxygen) {
			...
			log(H.incrementWithMax(false), "Hydrogen for Al(OH)3");
		} else {
